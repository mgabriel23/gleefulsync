    ...
    <div class="content mt-0">
        <?php
            ...
            $query = '
                ...
                WHERE platforms_tbl.short_name = "Others" 
            ...
            $stmt->execute();
            $others_attendees = $stmt->fetchAll();
        ?>
            <div class="table-responsive">
                <table class="table color-theme mb-2">
                    ...
                    <tbody>
                        <?php if ($others_attendees): ?>
                            <?php foreach ($others_attendees as $others_attendee): ?>
                                <tr class="border-fade-blue">
                                    <td><?php echo htmlspecialchars($others_attendee['group_no']); ?></td>
                                    <td><?php echo htmlspecialchars($others_attendee['member_name']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
