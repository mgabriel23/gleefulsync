    ...
    <div class="content mt-0">
        <?php
            ...
            $query = '
                ...
                WHERE platforms_tbl.short_name = "Locale"  
            ...
            $stmt->execute();
            $locale_attendees = $stmt->fetchAll();
        ?>
            <div class="table-responsive">
                <table class="table color-theme mb-2">
                    ...
                    <tbody>
                        <?php if ($locale_attendees): ?>
                            <?php foreach ($locale_attendees as $locale_attendee): ?>
                                <tr class="border-fade-blue">
                                    <td><?php echo htmlspecialchars($locale_attendee['group_no']); ?></td>
                                    <td><?php echo htmlspecialchars($locale_attendee['member_name']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
